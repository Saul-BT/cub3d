...
/*   Updated: 2025/12/14 11:34:48 by gade-oli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_window(t_win *win)
{
    ...
    win->ceiling_color = BLUE; //TODO: remove mock when parser is integrated
	win->floor_color = GREEN; //TODO: remove mock when parser is integrated
