...
void	set_defaults(t_cub3d *cub3d)
{
	...
	cub3d->mlx.img = NULL;
	cub3d->mlx.mlx = NULL;
	cub3d->mlx.north_img = NULL;
	cub3d->mlx.south_img = NULL;
	cub3d->mlx.east_img = NULL;
	cub3d->mlx.west_img = NULL;
	cub3d->mlx.floor_color = 0;
	cub3d->mlx.ceiling_color = 0;
	cub3d->texture = NULL;
}
...
void	free_cub3d(t_cub3d **cub3d)
{
	...
	free((*cub3d)->mlx.img);
	free((*cub3d)->mlx.mlx);
	free((*cub3d)->mlx.north_img);
	free((*cub3d)->mlx.south_img);
	free((*cub3d)->mlx.east_img);
	free((*cub3d)->mlx.west_img);
	i = 0;
